...
export function getWeatherAdvice(temperature, isRaining) {
    ...
    if (temperature >= 35)
        weatherAdvice = "Too hot for hiking - stay indoors and hydrate";
    else if (temperature >= 25)
        weatherAdvice = isRaining ? "Warm but rainy - consider indoor activities" : "Great weather for hiking - don't forget sunscreen";
    else if (temperature >= 15)
        weatherAdvice = isRaining ? "Cool and rainy - bring waterproof gear if hiking" : "Perfect hiking weather - enjoy the trails";
    else if (temperature >= 5)
        weatherAdvice = isRaining ? "Cold and wet - best to stay indoors" : "Chilly - wear layers for your hike";
    else
        weatherAdvice = "Too cold - stay warm indoors";
